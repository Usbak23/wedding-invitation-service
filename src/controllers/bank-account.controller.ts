...
export class BankAccountController {
    ...
    async getAll(@Param('invitationId', ParseUuidPipe) invitationId: string, @Req() req: Request & { user: { id: string } }) {
    ...
    async create(@Param('invitationId', ParseUuidPipe) invitationId: string, @Body() dto: CreateBankAccountDto, @Req() req: Request & { user: { id: string } }) {
